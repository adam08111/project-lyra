  ...
  if (screen === "source-setup") {
    return (
      <>
        ...
        />
        <StyleLab showStyleLab={showStyleLab} setShowStyleLab={setShowStyleLab} setSidebarOpen={setSidebarOpen} projects={projects} trackCall={trackCall} setAppliedSkill={setAppliedSkill} setWritingTechniques={setWritingTechniques} onApplySkill={applySkillWithEnrichment} initialTab={styleLabInitialTab} onOpenTraining={openTrainingSession} writingType={type} />
