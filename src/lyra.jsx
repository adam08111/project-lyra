  ...
  if (screen === "source-setup") {
    return (
      <>
        ...
        />
        <StyleLab showStyleLab={showStyleLab} setShowStyleLab={setShowStyleLab} activeWritingId={activeWritingId} trackCall={trackCall} setAppliedSkill={setAppliedSkill} setWritingTechniques={setWritingTechniques} onApplySkill={applySkillWithEnrichment} initialTab={styleLabInitialTab} onOpenTraining={openTrainingSession} writingType={type} />
