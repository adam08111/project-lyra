...
**Landing record.** Two commits (migration+DEPLOY / this log). Landing per CLAUDE.md #2 (maintainer same-session approval — granted in the directive that commissioned this fix). When landed FF, record the new `origin/main` sha here.
