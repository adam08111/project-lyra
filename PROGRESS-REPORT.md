...
**Landing record.** Commits (per unit — migration / emitter+outbox / seams / tests / docs / log). **Push/land OFFERED, not executed** (maintainer controls origin/main). Bundles with §111 (both pending on the branch). When landed FF, record the new `origin/main` sha here.
