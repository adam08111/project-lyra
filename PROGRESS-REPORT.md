...
**Landing record.** Commits (local, per unit — queries / roster-view / detail-view / dashboard-wiring / Class-D tests / docs): to be listed at land. **Push/land is OFFERED, not executed** (maintainer controls origin/main). When landed FF, record the new `origin/main` sha here.
